 ...
 * @author omar
 */
public class EcranAttenteDecisionAdminPartie extends JPanel{
	 ...
	 * @param jeu
	 */
	public EcranAttenteDecisionAdminPartie(JeuPanel jeu){
		// super("Attente",jeu);
		setLayout(null);
		...
		JLabel labelFond = new JLabel("<html><h1>" + Translator.translate("LeJeuEstEnPauseEnAttendantLaDecisionDeLadministrateurDeLaPartie")
